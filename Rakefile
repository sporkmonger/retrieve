...
require File.join(File.dirname(__FILE__), 'lib/retrieve', 'version')

PKG_DISPLAY_NAME   = 'Retrieve'
PKG_NAME           = PKG_DISPLAY_NAME.downcase
PKG_VERSION        = Retrieve::VERSION::STRING
...
PKG_SUMMARY        = "Simple resource access"
